...
# Load the data
data <- read_csv("./cleaned_sales_data.csv")

# Create a Time Series Object
# Assuming data is daily frequency=1. frequency=7 for weekly seasonality, 365 for yearly.
ts_data <- ts(data$Daily_Sales_Revenue, frequency = 1)
...
png("arima_residuals_diagnostics.png", width=800, height=600)
checkresiduals(fit)
dev.off()
